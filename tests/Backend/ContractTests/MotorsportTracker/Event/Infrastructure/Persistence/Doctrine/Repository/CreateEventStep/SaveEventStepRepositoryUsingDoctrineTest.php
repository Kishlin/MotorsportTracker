...
use Kishlin\Backend\MotorsportTracker\Event\Infrastructure\Persistence\Doctrine\Repository\CreateEventStep\SaveEventStepRepositoryUsingDoctrine;
use Kishlin\Tests\Backend\Tools\Test\Contract\CoreRepositoryContractTestCase;

/**
 * @internal
 * @covers \Kishlin\Backend\MotorsportTracker\Event\Infrastructure\Persistence\Doctrine\Repository\CreateEventStep\SaveEventStepRepositoryUsingDoctrine
 */
final class SaveEventStepRepositoryUsingDoctrineTest extends CoreRepositoryContractTestCase
{
    public function testItCanSaveAnEventStep(): void
    {
        ...
        $repository = new SaveEventStepRepositoryUsingDoctrine(self::entityManager());

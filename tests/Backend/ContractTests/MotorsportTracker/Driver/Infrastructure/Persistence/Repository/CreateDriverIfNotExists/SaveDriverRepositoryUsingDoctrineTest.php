...
use Kishlin\Backend\MotorsportTracker\Driver\Infrastructure\Persistence\Repository\CreateDriverIfNotExists\SaveDriverRepositoryUsingDoctrine;
...
/**
 * @internal
 * @covers \Kishlin\Backend\MotorsportTracker\Driver\Infrastructure\Persistence\Repository\CreateDriverIfNotExists\SaveDriverRepositoryUsingDoctrine
 */
final class SaveDriverRepositoryUsingDoctrineTest extends CoreRepositoryContractTestCase
{
    public function testItCanSaveADriver(): void
    {
        ...
        $repository = new SaveDriverRepositoryUsingDoctrine(self::connection());

...
use Kishlin\Backend\MotorsportTracker\Team\Infrastructure\Persistence\Repository\CreateTeamPresentationIfNotExists\SaveTeamPresentationRepositoryUsingDoctrine;
...
/**
 * @internal
 * @covers \Kishlin\Backend\MotorsportTracker\Team\Infrastructure\Persistence\Repository\CreateTeamPresentationIfNotExists\SaveTeamPresentationRepositoryUsingDoctrine
 */
final class SaveTeamPresentationRepositoryUsingDoctrineTest extends CoreRepositoryContractTestCase
{
    public function testItCanSaveATeam(): void
    {
        ...
        $repository = new SaveTeamPresentationRepositoryUsingDoctrine(self::connection());

...
use Kishlin\Backend\MotorsportTracker\Team\Infrastructure\Persistence\Repository\CreateTeamPresentationIfNotExists\SearchTeamPresentationRepositoryUsingDoctrine;
use Kishlin\Backend\Shared\Domain\ValueObject\UuidValueObject;
use Kishlin\Tests\Backend\Tools\Test\Contract\CoreRepositoryContractTestCase;

/**
 * @internal
 * @covers \Kishlin\Backend\MotorsportTracker\Team\Infrastructure\Persistence\Repository\CreateTeamPresentationIfNotExists\SearchTeamPresentationRepositoryUsingDoctrine
 */
final class SearchTeamPresentationRepositoryUsingDoctrineTest extends CoreRepositoryContractTestCase
{
    public function testItCanFindATeamPresentation(): void
    {
        self::loadFixture('motorsport.team.teamPresentation.redBullRacing2022');

        $repository = new SearchTeamPresentationRepositoryUsingDoctrine(self::connection());

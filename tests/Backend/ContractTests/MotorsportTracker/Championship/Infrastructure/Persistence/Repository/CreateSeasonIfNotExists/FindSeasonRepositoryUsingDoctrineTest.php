...
use Kishlin\Backend\MotorsportTracker\Championship\Infrastructure\Persistence\Repository\CreateSeasonIfNotExists\FindSeasonRepositoryUsingDoctrine;
use Kishlin\Tests\Backend\Tools\Test\Contract\CoreRepositoryContractTestCase;

/**
 * @internal
 * @covers \Kishlin\Backend\MotorsportTracker\Championship\Infrastructure\Persistence\Repository\CreateSeasonIfNotExists\FindSeasonRepositoryUsingDoctrine
 */
final class FindSeasonRepositoryUsingDoctrineTest extends CoreRepositoryContractTestCase
{
    public function testItCanFindTheSeason(): void
    {
        ...
        $repository = new FindSeasonRepositoryUsingDoctrine(self::connection());

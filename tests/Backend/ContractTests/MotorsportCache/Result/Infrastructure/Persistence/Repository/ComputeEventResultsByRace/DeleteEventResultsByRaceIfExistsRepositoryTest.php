...
use Kishlin\Backend\MotorsportCache\Result\Infrastructure\Persistence\Repository\ComputeEventResultsByRace\DeleteEventResultsByRaceIfExistsRepository;
use Kishlin\Tests\Backend\Tools\Test\Contract\CacheRepositoryContractTestCase;

/**
 * @internal
 * @covers \Kishlin\Backend\MotorsportCache\Result\Infrastructure\Persistence\Repository\ComputeEventResultsByRace\DeleteEventResultsByRaceIfExistsRepository
 */
final class DeleteEventResultsByRaceIfExistsRepositoryTest extends CacheRepositoryContractTestCase
{
    ...
    {
        $repository = new DeleteEventResultsByRaceIfExistsRepository(self::connection());

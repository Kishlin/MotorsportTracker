...
/**
 * @internal
 * @covers \Kishlin\Backend\MotorsportTracker\Standing\Domain\DTO\AnalyticsDriversStatsDTO
 * @covers \Kishlin\Backend\MotorsportTracker\Standing\Domain\Entity\AnalyticsDrivers
 */
final class AnalyticsDriversTest extends AggregateRootIsolatedTestCase
{
    public function testItCanBeCreated(): void
    {
        ...
        $entity = AnalyticsDrivers::create(
            ...
            AnalyticsDriversStatsDTO::fromScalars(
                $avgFinishPosition,
                $classWins,
                $fastestLaps,
                $finalAppearances,
        ...
        self::assertItRecordedDomainEvents($entity, new AnalyticsDriversCreatedDomainEvent(new UuidValueObject($id)));

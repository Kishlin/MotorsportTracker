...
func printUsage() {
	...
	fmt.Println("  scrape:series                                            Scrape all available series")
	fmt.Println("  scrape:seasons <series>                                  Scrape seasons for a series, by keyword")
	fmt.Println("  scrape:seasons-one <identifier>                          Scrape seasons for a series, by identifier")
	fmt.Println("  scrape:seasons-all                                       Scrape seasons for every known series")
	fmt.Println("  scrape:calendar <series> <year>                          Scrape the calendar for a series and year")
	fmt.Println("  scrape:classification <series> <year> <event> <session>  Scrape a classification")
	fmt.Println()
	fmt.Println("Examples:")
	fmt.Println("  motorsport-tracker scrape:series")
	fmt.Println("  motorsport-tracker scrape:seasons \"Formula One\"")
	fmt.Println("  motorsport-tracker scrape:calendar \"Formula One\" \"2025\"")
	fmt.Println("  motorsport-tracker scrape:classification \"Formula One\" \"2025\" \"British GP\" \"Race\"")
}

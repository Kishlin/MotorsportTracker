...
const StandingsPage: React.FunctionComponent<StandingsPageProps> = () => <p>Unimplemented.</p>;
    ...
    //                          <Chart options={chartOptions} series={drivers} type="line" width="98%" height={650} />}
    //                     </TabPanel>
    //                     <TabPanel value={tabIndex} index={1}>
    //                         {('undefined' !== typeof window) &&
    //                          <Chart options={chartOptions} series={teams} type="line" width="98%" height={650} />}
    //                     </TabPanel>
    //                 </Grid>
    //             </Grid>
    //         )}
...
//      await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/v1/standings/drivers/${championship}/${year}`);
//     const teamsResponse =
//      await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/v1/standings/teams/${championship}/${year}`);
//

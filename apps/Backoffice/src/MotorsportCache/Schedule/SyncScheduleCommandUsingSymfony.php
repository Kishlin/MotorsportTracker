...
final class SyncScheduleCommandUsingSymfony extends SymfonyCommand
{
    public const NAME = 'kishlin:motorsport-cache:schedule:compute';
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        try {
            ...
            $ui->error("Failed to compute schedule: {$e->getMessage()}");

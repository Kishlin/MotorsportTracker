...
final class SyncResultsForEventListCommandUsingSymfony extends AbstractEventCommandUsingSymfony
{
    ...
    {
        return 'Computes results for all events in the list.';
    }
    ...
    {
        $ui->error("Failed to results graphs: {$throwable->getMessage()}");
    }
}

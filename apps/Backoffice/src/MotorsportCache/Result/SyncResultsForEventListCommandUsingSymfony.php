...
final class SyncResultsForEventListCommandUsingSymfony extends SymfonyCommand
{
    public const NAME = 'kishlin:motorsport-cache:results:compute';
    ...
    protected function configure(): void
    {
        $this
            ->setName(self::NAME)
            ->setDescription('Computes results for all events in the list.')
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        try {
            ...
            $ui->error("Failed to get events: {$e->getMessage()}");

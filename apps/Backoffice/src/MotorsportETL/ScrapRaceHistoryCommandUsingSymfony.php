...
use Kishlin\Backend\MotorsportETL\RaceHistory\Application\ScrapRaceHistory\ScrapRaceHistoryFailures;
...
final class ScrapRaceHistoryCommandUsingSymfony extends CachableScrapCommandUsingSymfony
{
    public const NAME = 'kishlin:motorsport-etl:histories:scrap';
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        if (ScrapRaceHistoryFailures::NO_SESSIONS === $result->unwrapFailure()) {

...
use Kishlin\Backend\MotorsportTracker\Event\Infrastructure\Persistence\Repository\CreateEventIfNotExists\SearchEventRepository;
...
/**
 * @internal
 * @covers \Kishlin\Backend\MotorsportTracker\Event\Infrastructure\Persistence\Repository\CreateEventIfNotExists\SearchEventRepository
 */
final class SearchEventRepositoryTest extends CoreRepositoryContractTestCase
{
    public function testItReturnsTheIdWhenTheSeasonAndNameAreTaken(): void
    {
        ...
        $repository = new SearchEventRepository(self::connection());

...
final class TaskHandlerCompilerPass implements CompilerPassInterface
{
    /**
    ...
    {
        $container->addCompilerPass(new self(), PassConfig::TYPE_BEFORE_OPTIMIZATION, 70);
    }
    ...
    {
        foreach ($container->findTaggedServiceIds('kishlin.messaging.task_handler') as $service => $tag) {

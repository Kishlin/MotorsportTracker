...
namespace Kishlin\Backend\MotorsportTracker\Shared\Infrastructure\Persistence\Doctrine\EntityManagerFactory;
 ...
 *
 * All Namespaces live in the src/Backend/{MotorsportTracker, Shared, ...}/ folders and are scanned separately.
 ...
 */
final class MotorsportTrackerEntityManagerFactory
{
    /**
    ...
    {
        yield [
            'mainPath'      => __DIR__ . '/../../../../../../../../src/Backend/MotorsportTracker',
            'mappingsPath'  => 'Infrastructure/Persistence/Doctrine/Mapping',
            'typesPath'     => 'Infrastructure/Persistence/Doctrine/DbalTypes',
            'baseNamespace' => 'Kishlin\Backend\MotorsportTracker',
            'hasModules'    => true,
        ];

        yield [
            'mainPath'      => __DIR__ . '/../../../../../../../../src/Backend/MotorsportCache',
            'mappingsPath'  => 'Infrastructure/Persistence/Doctrine/Mapping',
            'typesPath'     => 'Infrastructure/Persistence/Doctrine/DbalTypes',
            'baseNamespace' => 'Kishlin\Backend\MotorsportCache',
            'hasModules'    => true,
        ];

...
use JsonException;
use Kishlin\Backend\MotorsportCache\Analytics\Application\UpdateDriverAnalyticsCache\DriverAnalyticsForSeasonDTO;
...
TXT;
    ...
    public function find(string $championship, int $year): DriverAnalyticsForSeasonDTO
    {
        ...
        return DriverAnalyticsForSeasonDTO::fromData($ret);
    }
}

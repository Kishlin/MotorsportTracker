...
use Kishlin\Backend\MotorsportCache\Result\Application\ComputeEventResultsByRace\NoRacesToComputeEvent;
...
final class NoRacesToComputeLogger implements EventSubscriber
{
    ...
    public function __invoke(NoRacesToComputeEvent $event): void
    {

...
final readonly class ComputeFastestLapDeltaOnClassificationScrapped implements EventSubscriber
{
    ...
    public function __invoke(ClassificationScrappingSuccessEvent $event): void
    {
        $this->commandBus->execute(
            ComputeFastestLapDeltaGraphCommand::fromScalars($event->eventId()),
        );
    }
}

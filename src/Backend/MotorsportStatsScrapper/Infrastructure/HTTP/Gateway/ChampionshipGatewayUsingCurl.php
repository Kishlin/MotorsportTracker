...
use Kishlin\Backend\MotorsportStatsScrapper\Infrastructure\DataModifier\Championship\AbstractChampionshipModifier;
...
final class ChampionshipGatewayUsingCurl implements ChampionshipGateway
{
    ...
    /** @var AbstractChampionshipModifier[] */
    private iterable $mutators;

    /**
     * @param AbstractChampionshipModifier[] $mutators
     */
    public function __construct(
        #[TaggedIterator('kishlin.motorsportcache.infrastructure.data-mutator.championship')] iterable $mutators,
